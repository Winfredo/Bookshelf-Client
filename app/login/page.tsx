...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const storedUsername = user.username || username || "Student";
      ...
      document.cookie = `username=${encodeURIComponent(storedUsername)}; path=/; max-age=${maxAge}; SameSite=Lax`;
          ...
          {mode === "login" && (
            <form className="space-y-5" onSubmit={handleLogin}>
              <div className="space-y-2">
                <label
                  className="block text-sm font-semibold text-[#041534] ml-1"
                  htmlFor="username"
                >
                  Username
                </label>
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-center px-1">
                  <label
                    className="block text-sm font-semibold text-[#041534]"
                    htmlFor="password"
                  >
                    Password
                  </label>
            ...
            <form className="space-y-5" onSubmit={handleSignup}>
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-gray-400 ml-1">
                  Must contain at least 7 characters, one uppercase letter and
              ...
              <p className="text-xs text-gray-400 text-center">
                By signing up you agree to our Terms of Service. All new
                accounts are created as students.
              </p>
            </form>
          )}
