      ...
      <main className="lg:ml-64 flex-1 min-h-screen px-6 md:px-16 py-12 pb-24">
        ...
        <header className="mb-12 flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4">
          <div>
            ...
            <p className="text-gray-500 text-lg">
              Your library overview for today.
            </p>
          </div>
          <div className="flex gap-4">
            ...
            <button
              ...
              className="bg-white/90 text-[#041534] border border-[#d1d5db] px-4 py-2 rounded-full font-semibold hover:bg-[#f4f5f7] transition-all"
            >
              Sign Out
            </button>
          </div>
        ...
        <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          ...
          <div className="bg-white/70 backdrop-blur-xl border border-white/30 border-r-4 border-r-[#041534] p-6 rounded-4xl shadow-sm flex flex-col justify-between h-48">
            ...
            <svg className="w-full h-12 mt-4" viewBox="0 0 100 30">
              <path
                d="M0 25 Q 10 15, 20 20 T 40 10 T 60 22 T 80 5 T 100 15"
                fill="none"
                stroke="#041534"
                strokeWidth="2"
          ...
          <div className="bg-white/70 backdrop-blur-xl border border-white/30 border-r-4 border-r-[#835500] p-6 rounded-4xl shadow-sm flex flex-col justify-between h-48">
            ...
            <svg className="w-full h-12 mt-4" viewBox="0 0 100 30">
              <path
                d="M0 20 Q 20 5, 40 25 T 60 15 T 80 20 T 100 5"
                fill="none"
                stroke="#835500"
                strokeWidth="2"
                vectorEffect="non-scaling-stroke"
          ...
          <div className="bg-white/70 backdrop-blur-xl border border-white/30 border-r-4 border-r-red-500 p-6 rounded-4xl shadow-sm flex flex-col justify-between h-48">
            ...
            <svg className="w-full h-12 mt-4" viewBox="0 0 100 30">
              <path
                d="M0 5 Q 20 25, 40 10 T 60 20 T 80 5 T 100 25"
                fill="none"
                stroke="#ba1a1a"
                strokeWidth="2"
                vectorEffect="non-scaling-stroke"
        ...
        <section className="mb-12">
          <div className="flex justify-between items-center mb-6">
            <h3 className="text-2xl font-semibold text-[#041534]">
              Recent Acquisitions
            </h3>
                ...
                <div className="p-4">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <div className="flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                      <button className="p-1 hover:text-[#835500] text-gray-400 transition-colors">
                        <FiEdit />
                      </button>
                      <button className="p-1 hover:text-red-500 text-gray-400 transition-colors">
                        <FiTrash2 />
                      </button>
                    </div>
                  </div>
              ...
              <table className="w-full text-left">
                <thead>
                  <tr className="bg-gray-50">
                    <th className="px-6 md:px-8 py-4 text-sm font-semibold text-[#041534]">
                      Student Name
                    </th>
                    <th className="px-6 md:px-8 py-4 text-sm font-semibold text-[#041534]">
                      Book Title
                    </th>
                    <th className="px-6 md:px-8 py-4 text-sm font-semibold text-[#041534] hidden md:table-cell">
                      Borrow Date
                    </th>
                    <th className="px-6 md:px-8 py-4 text-sm font-semibold text-[#041534]">
                      Due Date
                ...
                <tbody className="divide-y divide-gray-100">
                  {circulationData.map((row) => (
                    ...
                    >
                      ...
                      <td className="px-6 md:px-8 py-5 text-sm text-gray-800">
                        {row.book}
                      </td>
                      ...
                      <td
                        className={`px-6 md:px-8 py-5 text-sm font-medium ${row.status === "overdue" ? "text-red-500" : "text-gray-500"}`}
                      >
                        {row.dueDate}
                      </td>
                      <td className="px-6 md:px-8 py-5">
